//version 28 - like version 25 except linear performance function
...
parameters {
  ...
  real performance_on_effort_x_skill;
...
transformed parameters {
  ...
  for(i in 1:Ntotal){
    ...
    predicted_change_in_performance[i] = performance_intercept + performance_on_effort*predicted_effort[i] +
        performance_on_skill*predicted_skill[i] + performance_on_effort_x_skill*predicted_effort[i]*predicted_skill[i];
