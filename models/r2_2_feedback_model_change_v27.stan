//version 27 - like version 25 except linear model of skill
...
transformed parameters {
  ...
  for(i in 1:Ntotal){
    ...
    predicted_skill[i] = skill_intercept + skill_slope*practice[i];
...
model {
  ...
  skill_intercept ~ normal(0,5);
  skill_slope ~ normal(0,5);
