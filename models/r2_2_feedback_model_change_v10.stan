//version 10 - like version 5 accept removed the effect of predicted skill/ability on effort.
  ...
  for(i in 1:Ntotal){
    ...
    if(time[i]==1){
      if(trial[i]==1){
        ...
        predicted_effort[i] = eff_0*alpha + gain11*predicted_goal[global_trial_number[i]];
      ...
      if(trial[i]>1){
        ...
        predicted_effort[i] =   predicted_effort[i-1]*alpha + gain11*predicted_goal[global_trial_number[i]];
