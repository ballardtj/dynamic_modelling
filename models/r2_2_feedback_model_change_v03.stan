//version 3 - changed performance function so skill could affect multiple parameters of effort/performance relationship
...
transformed parameters {
  ...
  for(i in 1:Ntotal){
    ...
    if(time[i]==1){
      ...
      predicted_effort[i] = eff_start*alpha + gain11*predicted_goal[global_trial_number[i]] + gain12*predicted_ability[i]*predicted_goal[global_trial_number[i]];
