//version 22 - like version 21 except without intercept in performance assymtpte equation
...
transformed parameters {
  ...
  for(i in 1:Ntotal){
    ...
    predicted_change_in_performance[i] = (gain22*predicted_skill[i]) / (1 + exp(-(gain20 + gain21*predicted_effort[i]  ) ));
