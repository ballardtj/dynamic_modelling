//version 24 - like version 23 except performance assymptote is just skill and upper bound AND lower bounds of learning curve are free
...
model {
  ...
  skill_min ~ normal(0,1);
  skill_change ~ normal(0,1);
