...
dperf2 =~ 1*perf2     # Fixed regression 
dperf3 =~ 1*perf3     # Fixed regression 
dperf4 =~ 1*perf4     # Fixed regression 
dperf5 =~ 1*perf5     # Fixed regression 
dperf6 =~ 1*perf6     # Fixed regression 
dperf7 =~ 1*perf7     # Fixed regression 
dperf8 =~ 1*perf8     # Fixed regression 
dperf9 =~ 1*perf9     # Fixed regression 
dperf10 =~ 1*perf10   # Fixed regression
...
dperf2~label("sf")*perf1              # This estimates the self-feedback parameter
dperf3~equal("sf")*perf2              # This estimates the self-feedback parameter
dperf4~equal("sf")*perf3              # This estimates the self-feedback parameter
dperf5~equal("sf")*perf4              # This estimates the self-feedback parameter
dperf6~equal("sf")*perf5              # This estimates the self-feedback parameter
dperf7~equal("sf")*perf6              # This estimates the self-feedback parameter
dperf8~equal("sf")*perf7              # This estimates the self-feedback parameter
dperf9~equal("sf")*perf8              # This estimates the self-feedback parameter
dperf10~equal("sf")*perf9             # This estimates the self-feedback parameter
...
perf1 ~~ 0*perf1
perf2 ~~ 0*perf2
perf3 ~~ 0*perf3        # This line constrains the intercept of X3 to 0
perf4 ~~ 0*perf4        # This line constrains the intercept
perf5 ~~ 0*perf5         # This line constrains the intercept
perf6 ~~ 0*perf6         # This line constrains the intercept
perf7 ~~ 0*perf7         # This line constrains the intercept
perf8 ~~ 0*perf8         # This line constrains the intercept
perf9 ~~ 0*perf9         # This line constrains the intercept
perf10 ~~ 0*perf10         # This line constrains the intercept
