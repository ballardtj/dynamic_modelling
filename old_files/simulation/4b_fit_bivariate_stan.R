...
fit = stan(file="./models/stan_perf_goal_static.stan",
           data=model_data,cores=1)

save(fit,file="../model_output/bivariate_stan_to_LCSM_sim.RData")

smry=summary(fit)

write.csv(smry$summary,file="../model_output/bivariate_stan_to_LCSM_sim_smry.csv")
